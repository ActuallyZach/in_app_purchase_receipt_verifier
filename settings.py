...
APP_SPECIFIC_SHARED_SECRET_JELLY = os.environ.get("APP_SPECIFIC_SHARED_SECRET_JELLY")
RECEIPT_VERIFICATION_ENVIRONMENT_JELLY = os.environ.get("RECEIPT_VERIFICATION_ENVIRONMENT_JELLY")
BASE64_ENCODED_SIGNING_KEY_JELLY = os.environ.get("BASE64_ENCODED_SIGNING_KEY_JELLY")

APP_SPECIFIC_SHARED_SECRET_SCUM = os.environ.get("APP_SPECIFIC_SHARED_SECRET_SCUM")
RECEIPT_VERIFICATION_ENVIRONMENT_SCUM = os.environ.get("RECEIPT_VERIFICATION_ENVIRONMENT_SCUM")
BASE64_ENCODED_SIGNING_KEY_SCUM = os.environ.get("BASE64_ENCODED_SIGNING_KEY_SCUM")
